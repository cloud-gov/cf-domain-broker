...
type CloudfrontDistributionIface interface {
...
func (d *CloudfrontDistribution) getAliases(domains []string) *cloudfront.Aliases {
	var items []*string
...
func (d *CloudfrontDistribution) getTags(tags map[string]string) *cloudfront.Tags {
...
func (d *CloudfrontDistribution) getHeaders(headers []string) *cloudfront.Headers {
...
// be passed in.
func (d *CloudfrontDistribution) fillDistributionConfig(config *cloudfront.DistributionConfig, origin, path string,
...
func (d *CloudfrontDistribution) Create(callerReference string, domains []string, origin, path string, insecureOrigin bool, forwardedHeaders []string, forwardCookies bool, tags map[string]string) (*cloudfront.Distribution, error) {
...
func (d *CloudfrontDistribution) Update(distId string, domains []string, origin, path string, insecureOrigin bool, forwardedHeaders types.Headers, forwardCookies bool) (*cloudfront.Distribution, error) {
...
func (d *CloudfrontDistribution) Get(distId string) (*cloudfront.Distribution, error) {
...
func (d *CloudfrontDistribution) SetCertificateAndCname(distId, certId string, domains []string) error {
...
func (d *CloudfrontDistribution) SetCertificate(distId, certId string) error {
	resp, err := d.Service.GetDistributionConfig(&cloudfront.GetDistributionConfigInput{
		Id: aws.String(distId),
	})
	if err != nil {
...
func (d *CloudfrontDistribution) Disable(distId string) error {
	resp, err := d.Service.GetDistributionConfig(&cloudfront.GetDistributionConfigInput{
		Id: aws.String(distId),
	})
	if err != nil {
...
func (d *CloudfrontDistribution) Delete(distId string) (bool, error) {
	resp, err := d.Service.GetDistribution(&cloudfront.GetDistributionInput{
		Id: aws.String(distId),
	})
	if err != nil {
...
func (d *CloudfrontDistribution) ListDistributions(callback func(cloudfront.DistributionSummary) bool) error {
